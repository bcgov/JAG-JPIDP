...
describe('DriverFitnessResolver', () => {
  let resolver: DigitalEvidenceResolver;
  let driverFitnessResourceSpy: Spy<DigitalEvidenceResource>;
  ...
  beforeEach(() => {
    ...
    resolver = TestBed.inject(DigitalEvidenceResolver);
    driverFitnessResourceSpy = TestBed.inject<any>(DigitalEvidenceResource);
    ...
    mockProfileStatus = {
      ...
      status: {
        ...
        organizationDetails: { statusCode: StatusCode.INCOMPLETE },
        facilityDetails: { statusCode: StatusCode.INCOMPLETE },
        userAccessAgreement: { statusCode: StatusCode.INCOMPLETE },
        saEforms: { statusCode: StatusCode.INCOMPLETE },
        hcimAccountTransfer: { statusCode: StatusCode.INCOMPLETE },
        hcimEnrolment: { statusCode: StatusCode.INCOMPLETE },
        driverFitness: { statusCode: StatusCode.INCOMPLETE },
        digitalEvidence: { statusCode: StatusCode.INCOMPLETE },
        sitePrivacySecurityChecklist: { statusCode: StatusCode.INCOMPLETE },
        complianceTraining: { statusCode: StatusCode.INCOMPLETE },
      },
    };
  });

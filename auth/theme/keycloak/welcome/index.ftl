...
<html>
<head>
    <title>Welcome to ${properties.productNameFull!}</title>
  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      <div class="welcome-header">
        ...
        <h1>Welcome to <strong>${properties.productNameFull}</strong></h1>
      </div>
      <div class="row">
          ...
          <div class="card-pf h-l">
            ...
            <div class="welcome-primary-link">
              ...
              <div class="description">
                Centrally manage all aspects of the ${properties.productNameFull} server
              </div>
            </div>
          </div>
        </div>

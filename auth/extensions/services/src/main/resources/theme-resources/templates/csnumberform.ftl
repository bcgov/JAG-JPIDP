            ...
            <div id="kc-form-wrapper">
                ...
                <form class="${properties.kcFormClass!}" id="kc-form-login" action="${url.loginAction}" method="post">
                    ...
                    <div class="${properties.kcFormGroupClass!}">
                        <input class="digit" id="cs_num_1" type="number" name="cs_num_1" min="0" max="9" maxlength="1" autofocus/>
                        <input class="digit" id="cs_num_2" type="number" name="cs_num_2" min="0" max="9" maxlength="1" />
                        <input class="digit" id="cs_num_3" type="number" name="cs_num_3" min="0" max="9" maxlength="1" />
                        <input class="digit" id="cs_num_4" type="number" name="cs_num_4" min="0" max="9" maxlength="1" />
                        <input class="digit" id="cs_num_5" type="number" name="cs_num_5" min="0" max="9" maxlength="1" />
                        <input class="digit" id="cs_num_6" type="number" name="cs_num_6" min="0" max="9" maxlength="1" />
                        <input class="digit" id="cs_num_7" type="number" name="cs_num_7" min="0" max="9" maxlength="1" />
                        <input class="digit" id="cs_num_8" type="number" name="cs_num_8" min="0" max="9" maxlength="1" />
                    </div>

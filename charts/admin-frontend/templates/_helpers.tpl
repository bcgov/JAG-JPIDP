...
app.kubernetes.io/name: {{ include "admin-frontend.name" . }}
...
*/}}
{{- define "admin-frontend.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "admin-frontend.fullname" .) .Values.serviceAccount.name }}
{{- else }}

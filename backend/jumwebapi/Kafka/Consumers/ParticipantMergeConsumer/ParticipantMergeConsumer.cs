...
public class ParticipantMergeConsumer<TKey, TValue>(ConsumerConfig config, IKafkaHandler<TKey, TValue> handler, IConsumer<TKey, TValue> consumer, string topic, IServiceScopeFactory serviceScopeFactory) : IKafkaConsumer<TKey, TValue> where TValue : class
{

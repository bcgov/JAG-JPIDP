...
namespace Pidp.Data.Migrations
{
    ...
    [Migration("20240816183647_CaseAccessDeletionsNullable")]
    partial class CaseAccessDeletionsNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pidp.Models.UserInfo.PartyUserType", b =>
                {
                    ...
                    b.Property<int>("UserTypeLookupId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pidp.Models.DigitalEvidenceDefence", b =>
                {
                    ...
                    b.Property<string>("EdtExternalIdentifier")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("ManuallyAddedParticipantId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pidp.Models.UserInfo.PartyUserType", b =>
                {
                    b.HasOne("Pidp.Models.Party", "Party")
                        .WithMany("PartyUserTypes")
                        .HasForeignKey("PartyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pidp.Models.UserInfo.UserTypeLookup", "UserTypeLookup")
                        .WithMany()
                        .HasForeignKey("UserTypeLookupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Party");

                    b.Navigation("UserTypeLookup");
                });

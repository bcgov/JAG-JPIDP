...
public interface IEdtClient
{
    ...
    Task<UserModificationEvent> ModifyPerson(EdtPersonProvisioningModel accessRequest, EdtPersonUpdateDto currentUser);
    ...
    Task<EdtPersonUpdateDto?> GetPerson(string userKey);
